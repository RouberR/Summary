...
const translations = {
  en: {
    ...
    'hero.desc':       'React Native Developer with 4+ years of experience building mobile apps for iOS & Android. FinTech · HealthTech · FoodTech',
    ...
    'about.p1': 'I\'m <strong>Yauheni Fiadosenka</strong>, a <strong>React Native Developer</strong> with 4+ years of commercial experience building mobile applications for iOS and Android. I have worked on <strong>FinTech, HealthTech, and FoodTech</strong> products: from architecture and core feature development to App Store and Google Play releases.',
    'about.p2': 'I have experience building mobile applications from scratch, setting up release processes, integrating third-party SDKs, analytics, push notifications, subscriptions, offline functionality, and performance optimization.',
    'about.p3': 'I have experience as a lead mobile/frontend developer: architecture decisions, code review, mentoring junior developers, and collaboration with backend, product, design, and QA teams.',
    'about.p4': 'I use AI tools in development: <strong>Codex, Cursor, and Claude</strong> for code analysis, prototyping, refactoring, documentation, and speeding up routine engineering work.',
    'about.p5': 'I prefer projects where I can influence technical decisions, implementation quality, app stability, and long-term mobile product development.',
    ...
    'exp.nvt.items': [
      'Designed and implemented a mobile application from scratch using React Native and Expo',
      'Configured the release pipeline: EAS Build, EAS Submit, OTA Updates, App Store and Google Play publication',
      'Integrated Sentry for error monitoring and Expo Notifications for push notifications',
      'Collaborated with the backend team on API design and integration',
      'Maintained technical documentation for architecture, builds, releases, and integrations',
    ],
    'exp.softarex.items': [
      'Acted as the lead mobile/frontend developer for a React Native app on iOS and Android',
      'Built key product modules: family accounts, roles and access control, multi-currency support, discounted subscriptions, and offline mode',
      'Integrated and configured Finicity, Amplitude, Firebase, and Appsflyer',
      'Set up user event analytics and product metric tracking',
      'Improved app performance, screen stability, and overall user experience',
      'Refactored the codebase, updated dependencies, and kept the project technically up to date',
    ],
    'exp.tapston.items': [
      'Developed and maintained multiple iOS and Android applications, including projects built from scratch',
      'Implemented push notifications, payments, third-party SDK integrations, localization, and analytics',
      'Contributed to a large-scale banking application: architecture, infrastructure, feature development, and debugging',
      'Prepared iOS and Android test builds and collaborated with QA on bugs and regressions',
  ...
  ru: {
    ...
    'hero.desc':       'React Native разработчик с 4+ годами опыта создания мобильных приложений для iOS и Android. FinTech · HealthTech · FoodTech',
    ...
    'about.p1': '<strong>React Native Developer</strong> с 4+ годами коммерческого опыта в разработке мобильных приложений для iOS и Android. Работал над продуктами в <strong>FinTech, HealthTech и FoodTech</strong>: от проектирования архитектуры и разработки ключевой функциональности до публикации приложений в App Store и Google Play.',
    'about.p2': 'Есть опыт создания мобильных приложений с нуля, настройки release-процессов, интеграции сторонних SDK, аналитики, push-уведомлений, подписок, offline-функциональности и оптимизации производительности.',
    'about.p3': 'Имею опыт роли ведущего mobile/frontend-разработчика: участвовал в архитектурных решениях, проводил code review, помогал младшим разработчикам, взаимодействовал с backend, product, design и QA-командами.',
    'about.p4': 'Использую AI-инструменты в разработке: <strong>Codex, Cursor и Claude</strong> для анализа кода, прототипирования, рефакторинга, подготовки документации и ускорения рутинных инженерных задач.',
    'about.p5': 'Предпочитаю проекты, где можно влиять на технические решения, качество реализации, стабильность приложения и долгосрочное развитие mobile-направления.',
    ...
    'exp.nvt.items': [
      'Спроектировал и реализовал мобильное приложение с нуля на React Native и Expo',
      'Настроил release pipeline: EAS Build, EAS Submit, OTA Updates, публикация в App Store и Google Play',
      'Интегрировал Sentry для мониторинга ошибок и Expo Notifications для push-уведомлений',
      'Взаимодействовал с backend-командой при проектировании и подключении API',
      'Вёл техническую документацию проекта: архитектура, сборки, релизы и интеграции',
    ],
    'exp.softarex.items': [
      'Выполнял роль ведущего mobile/frontend-разработчика React Native приложения для iOS и Android',
      'Разрабатывал ключевые продуктовые модули: семейные аккаунты, роли и права доступа, мультивалютность, подписки со скидками и offline mode',
      'Интегрировал и настраивал Finicity, Amplitude, Firebase и Appsflyer',
      'Настраивал аналитику пользовательских событий и продуктовых метрик',
      'Оптимизировал производительность приложения, улучшал стабильность экранов и пользовательский опыт',
      'Проводил рефакторинг кодовой базы, обновлял зависимости и поддерживал техническую актуальность проекта',
    ],
    'exp.tapston.items': [
      'Разрабатывал и поддерживал несколько мобильных приложений для iOS и Android, включая проекты с полным циклом разработки с нуля',
      'Реализовывал push-уведомления, платежи, интеграции сторонних SDK, локализацию и аналитику',
      'Участвовал в разработке крупного банковского приложения: архитектура, инфраструктура, функционал и отладка',
      'Готовил тестовые сборки для iOS и Android, взаимодействовал с QA-командой по багам и регрессиям',
      'Наставлял младших разработчиков и участвовал в code review',
    ],
